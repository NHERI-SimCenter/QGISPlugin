...
set BUILDDIR=C:\Users\Office\Desktop\SimCenter\QGIS\Build_Debug
...
set OSGEO4W_CXXFLAGS=/MDd /Z7 /MP /Od /D /bigobj DEBUG
...
cmake -G "%CMAKEGEN%" ^
	...
	-D CMAKE_INSTALL_PREFIX=C:\Users\Office\Desktop\QGIS\Install_Debug ^
	...
	-D PROJ_LIBRARY=%O4W_ROOT%/lib/proj_d.lib ^
	...
	-D QCA_LIBRARY=%OSGEO4W_ROOT%\apps\Qt5\lib\qca-qt5d.lib ^
	-D QSCINTILLA_LIBRARY=%OSGEO4W_ROOT%\apps\Qt5\lib\qscintilla2_qt5d.lib ^
	-D QWT_LIBRARY=%OSGEO4W_ROOT%\apps\Qt5\lib\qwtd.lib ^
	-D QTKEYCHAIN_LIBRARY=%OSGEO4W_ROOT%\apps\Qt5\lib\qt5keychaind.lib ^
