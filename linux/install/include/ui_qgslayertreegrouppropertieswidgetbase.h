...
public:
    ...
    {
        QgsLayerTreeGroupPropertiesWidgetBase->setWindowTitle(QCoreApplication::translate("QgsLayerTreeGroupPropertiesWidgetBase", "Annotation Item Properties", nullptr));
