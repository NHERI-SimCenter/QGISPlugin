...
public:
    ...
    void retranslateUi(QDialog *QgsOWSSourceSelectBase)
    {
        ...
        mWMSGroupBox->setTitle(QCoreApplication::translate("QgsOWSSourceSelectBase", "Options", nullptr));
        mLayerNameLabel->setText(QCoreApplication::translate("QgsOWSSourceSelectBase", "Layer name", nullptr));
        mTileSizeLabel->setText(QCoreApplication::translate("QgsOWSSourceSelectBase", "Tile size", nullptr));
        mFeatureCountLabel->setText(QCoreApplication::translate("QgsOWSSourceSelectBase", "Feature limit for GetFeatureInfo", nullptr));
