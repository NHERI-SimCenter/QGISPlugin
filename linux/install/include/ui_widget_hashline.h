...
public:
    ...
    void setupUi(QWidget *WidgetHashedLine)
    {
        ...
        gridLayout->addWidget(mCheckPlaceOnEveryPart, 4, 0, 1, 5);
...
#if QT_CONFIG(tooltip)
        mCheckPlaceOnEveryPart->setToolTip(QCoreApplication::translate("WidgetHashedLine", "If checked, the \"first vertex\" or \"last vertex\" placements will rendered at the first and last vertex for every part of multipart geometries", nullptr));
#endif // QT_CONFIG(tooltip)
        mCheckPlaceOnEveryPart->setText(QCoreApplication::translate("WidgetHashedLine", "Place on every part", nullptr));
