...
public:
    ...
    void setupUi(QWidget *QgsVectorElevationPropertiesWidgetBase)
    {
        ...
        QgsVectorElevationPropertiesWidgetBase->resize(555, 524);
        ...
        gridLayout_2->addWidget(mComboClamping, 0, 0, 1, 3);
        ...
        gridLayout_4->addWidget(mLabelBindingExplanation_2, 0, 0, 1, 2);
        ...
        QWidget::setTabOrder(mOffsetZSpinBox, mExtrusionGroupBox);
        QWidget::setTabOrder(mExtrusionGroupBox, mExtrusionSpinBox);
        QWidget::setTabOrder(mExtrusionSpinBox, mBindingGroupBox);
    ...
    void retranslateUi(QWidget *QgsVectorElevationPropertiesWidgetBase)
    {
        ...
        label->setText(QCoreApplication::translate("QgsVectorElevationPropertiesWidgetBase", "Offset", nullptr));
