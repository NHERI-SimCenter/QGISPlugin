...
public:
    ...
    QLabel *mVerticalDistanceLabel_2;
    ...
    void setupUi(QWidget *WidgetPointPatternFill)
    {
        ...
        mVerticalDistanceLabel_2 = new QLabel(WidgetPointPatternFill);
        mVerticalDistanceLabel_2->setObjectName(QString::fromUtf8("mVerticalDistanceLabel_2"));

        gridLayout->addWidget(mVerticalDistanceLabel_2, 11, 0, 1, 1);
        ...
        mOffsetLabel_2 = new QLabel(WidgetPointPatternFill);
        mOffsetLabel_2->setObjectName(QString::fromUtf8("mOffsetLabel_2"));

        gridLayout->addWidget(mOffsetLabel_2, 10, 0, 1, 1);
    ...
    void retranslateUi(QWidget *WidgetPointPatternFill)
    {
        ...
        mVerticalDistanceLabel_2->setText(QCoreApplication::translate("WidgetPointPatternFill", "Angle", nullptr));
        ...
        mOffsetLabel_2->setText(QCoreApplication::translate("WidgetPointPatternFill", "Clipping", nullptr));
