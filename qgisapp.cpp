    ...
    : QMainWindow( parent, fl )
{
    ...
    // load providers
    mStatusBar->showMessage( tr( "Checking provider plugins" ));
    qApp->processEvents();
    ...
    mStatusBar->showMessage( tr( "Starting Python" ));
    qApp->processEvents();
    // loadPythonSupport();
    ...
    mStatusBar->showMessage( tr( "Restoring loaded plugins" ));
    qApp->processEvents();
    ...
    mStatusBar->showMessage( tr( "Updating recent project paths" ), Qt::AlignHCenter | Qt::AlignBottom );
    qApp->processEvents();
    ...
    mStatusBar->showMessage( tr( "Initializing file filters" ));
    qApp->processEvents();
    ...
    //
    mStatusBar->showMessage( tr( "Restoring window state" ));
    qApp->processEvents();
    ...
    mStatusBar->showMessage( tr( "Populate saved styles" ));
    startProfile( tr( "Populate saved styles" ) );
    QgsStyle::defaultStyle();
    endProfile();

    mStatusBar->showMessage( tr( "SimCenter + QGIS" ));
...
void QgisApp::applyDefaultSettingsToCanvas( QgsMapCanvas *canvas )
{
    ...
    canvas->setMapUpdateInterval( settings.value( QStringLiteral( "qgis/map_update_interval" ), 125 ).toInt() );
...
void QgisApp::removeLayer(bool promptConfirmation)
{
    ...
    if(promptConfirmation == true)
        promptConfirmation = QgsSettings().value( QStringLiteral( "qgis/askToDeleteLayers" ), true ).toBool();
...
void QgisApp::setupActions()
{
    ...
    mActionCircularStringCurvePoint = new QAction(this);
    ...
    mActionCircularStringRadius = new QAction(this);
    ...
    mActionCircle2Points = new QAction(this);
    ...
    mActionCircle3Points = new QAction(this);
    ...
    mActionCircleCenterPoint = new QAction(this);
    ...
    mActionEllipseCenter2Points = new QAction(this);
    ...
    mActionEllipseCenterPoint = new QAction(this);
    ...
    mActionEllipseExtent = new QAction(this);
    ...
    mActionEllipseFoci = new QAction(this);
    ...
    mActionRectangleExtent = new QAction(this);
    ...
    mActionRectangleCenterPoint = new QAction(this);
    ...
    mActionRegularPolygonCenterPoint = new QAction(this);
    ...
    mActionRegularPolygon2Points = new QAction(this);
    ...
    mActionCircle3Tangents = new QAction(this);
    ...
    mActionRectangle3PointsDistance = new QAction(this);
    ...
    mActionCircle2TangentsPoint = new QAction(this);
    ...
    mActionRegularPolygonCenterCorner = new QAction(this);
    ...
    mActionRectangle3PointsProjected = new QAction(this);
...
{
    menubar = mainWindow->menuBar()->addMenu("GIS Map");
