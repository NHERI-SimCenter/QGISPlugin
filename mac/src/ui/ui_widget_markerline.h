...
public:
    ...
    void setupUi(QWidget *WidgetMarkerLine)
    {
        ...
        gridLayout->addWidget(mCheckPlaceOnEveryPart, 2, 0, 1, 5);
        ...
        QWidget::setTabOrder(mCheckCurvePoint, mSpinOffsetAlongLine);
        ...
        QWidget::setTabOrder(chkRotateMarker, mCheckPlaceOnEveryPart);
        QWidget::setTabOrder(mCheckPlaceOnEveryPart, mSpinAverageAngleLength);
...
#if QT_CONFIG(tooltip)
        mCheckPlaceOnEveryPart->setToolTip(QCoreApplication::translate("WidgetMarkerLine", "If checked, the \"first vertex\" or \"last vertex\" placements will rendered at the first and last vertex for every part of multipart geometries", nullptr));
#endif // QT_CONFIG(tooltip)
        mCheckPlaceOnEveryPart->setText(QCoreApplication::translate("WidgetMarkerLine", "Place on every part", nullptr));
